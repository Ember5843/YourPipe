/*
 * MPV player N-API bridge for OHOS.
 *
 * The ArkTS surface derives from the upstream `wang-bin/libmdk-napi`
 * package (historical `mdk` names in old commits); playback is MPV only.
 */
