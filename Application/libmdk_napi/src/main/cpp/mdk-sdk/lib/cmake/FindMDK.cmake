...
set(MDK_RUNTIME_DIR ${_IMPORT_PREFIX}/lib)
if(WIN32)
  set(MDK_RUNTIME_DIR ${_IMPORT_PREFIX}/bin)
endif()
if(EXISTS "${MDK_RUNTIME_DIR}/${_IMPORT_ARCH}")
  set(MDK_RUNTIME_DIR "${MDK_RUNTIME_DIR}/${_IMPORT_ARCH}")
endif()
